...
public class FollowService {
    ...
    public List<Map<String, Object>> findFollowees(int userId, int offset, int limit){
        String followeeKey = RedisKeyUtil.getFolloweeKey(userId, ForumConstants.ENTITY_TYPE_USER);
        ...
        while (iterator.hasNext()){
            ...
            Integer targetId = iterator.next();
    ...
    public List<Map<String, Object>> findFollowers(int userId, int offset, int limit) {
        String followerKey = RedisKeyUtil.getFollowerKey(ForumConstants.ENTITY_TYPE_USER, userId);
